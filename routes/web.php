...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/dashboard/products/detail/{id}', 'DashboardProductController@detail')->name('dashboard-product-detail');
    ...
    Route::post('/dashboard/products/gallery/delete/{id}', 'DashboardProductController@deleteGallery')->name('dashboard-product-gallery-delete');

    Route::get('/dashboard/transactions', 'DashboardTransactionController@index')->name('dashboard-transaction');
    Route::get('/dashboard/transactions/{id}', 'DashboardTransactionController@detail')->name('dashboard-transcation-detail');
