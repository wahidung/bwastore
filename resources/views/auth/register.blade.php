        ...
        <div class="col-lg-4">
          ...
          <form method="POST" class="mt-3" action="{{ route('register') }}">
            ...
            <div class="form-group">
              ...
              <input id="name" v-model="name" type="text" class="form-control @error('name') is-invalid @enderror"
            ...
            <div class="form-group">
              <label>Email</label>
              <input id="email" v-model="email" type="email" class="form-control @error('email') is-invalid @enderror"
                :class="{ 'is-invalid': this.email_unavailable }" name="email" value="{{ old('email') }}" required
                autocomplete="email" autofocus @change="checkEmail()">
            ...
            <div class="form-group">
              ...
              <input id="password_confirm" type="password"
                class="form-control @error('password_confirm') is-invalid @enderror" name="password_confirmation"
            ...
            <div class="form-group" v-if="is_store_open">
              ...
              <input type="text" v-model="store_name" id="store_name  "
                class="form-control @error('store_name') is-invalide @enderror" name="store_name" required autocomplete
