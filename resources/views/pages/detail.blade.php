        ...
        <div class="row">
          ...
          <div class="col-lg-2" data-aos="zoom-in">
            ...
            <form action="{{ route('detail-add', $product->id) }}" method="POST">
              @csrf
              <button class="btn btn-success nav-link px-4 text-white btn-block mb-3" type="submit">Add to Cart</button>
            </form>
            @else
            <a class="btn btn-success nav-link px-4 text-white btn-block mb-3" href="{{ route('login') }}">Add to
              Cart</a>
            @endauth
          </div>
        </div>
