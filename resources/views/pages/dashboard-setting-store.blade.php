...
@section('title','Setting Store Store')
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="categories_id" id="category" class="form-control">
                        ...
                        <option value="{{ $category->id }}" @if($user->categories_id == $category->id) selected
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" name="store_status" id="openStoreFalse"
                          value="0" {{ $user->store_status != 1 ? 'checked' : '' }} />
